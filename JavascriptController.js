   ...
   if( status == 'stop'  &&  requested == optionA) {
    ...
    for(optionA;optionA<=requested;optionA++){
     ...
     //option for elevator B
      ...
      for(optionB;optionB<requested;requested++){
      ...
      else if(status == 'up' | status == 'down' &&  directionB=='idle' && optionB < 5 && requested < 5  &&  optionB > requested ){
        ...
        else if(status == 'up' | status == 'down' &&  directionA=='idle' && optionA < 5 && requested < 5  &&  optionA < requested ){
                    ...
                    console.log(optionB);
                     ...
                     for(optionB;requested<=optionA;optionA--){
                        ...
                        for(optionA;requested<=optionA;optionA--){
                         ...
                         else if(status == 'up' | status == 'down' &&  directionB=='moving' && optionB > 5 && requested > 5  &&  optionB > requested ){
                          console.log('ELEVATOR B IS COMMING');
                          ...
                          for(optionB;requested<=optionB;optionB--){
                           ...
                           else if(status == 'up' | status == 'down' &&  directionA=='moving' && optionA > 5 && requested > 5  &&  optionA > requested ){
                            console.log('ELEVATOR A IS COMMING');
